...
import targetmixImage from '../../assets/Images/TargetStarbs mix.jpg'; 
...
const authStyles = {
    main: {
        backgroundImage: `linear-gradient(rgba(0, 0, 0, .3), rgba(0, 0, 0, .5)), url(${targetmixImage});`,
        width: '100%',
        height: '100%',
    ...
    return (
        <Box>
            <Button
                ...
                onClick = { signIn }
            >
                Sign In to get 50% off your next Starbucks drink!
            </Button>
            <Snackbar
                open = {open}
